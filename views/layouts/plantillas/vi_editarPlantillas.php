            ...
            <div class="admin-contenido">
                <form name="frmGuardar" id="frmGuardar" class="" class="row g-3 needs-validation was-validated">
                    <div class="col-12 col-md-12">
                        ...
                        <input type="text" name="nombre" id="nombre" value="Este es el nombre del documento" class="form-control" required>
                    </div>
                    <div class="col-12 col-md-12">
                        <label for="Descripcion" class="form-label" >Descripción Corta *</label>
                        <textarea name="" class="form-control" id=""  rows="3">Esta es la descripción corta</textarea>
                    </div>
                    <div class="col-12 col-md-12">
                        ...
                        <select name="" id="" class="form-control">
                            ...
                            <option selected>Plantilla 3</option>
                        </select>
                    </div>
                    <div class="col-12 col-md-12">
                    ...
                    <div class="col-md-12 d-grid justify-content-center">
                        <label for="downloadFile" style="text-align: center;" class="form-label">Descargar Documento</label>
